...
function BustPortrait() {
  return (
    ...
    >
      ...
      <path d="M 33 100 C 33 88 38 78 44 74.5 L 56 74.5 C 62 78 67 88 67 100 Z" fill="#e94f64" />
      <rect x="46" y="82" width="8" height="6" rx="2" fill="#d13a50" stroke="none" />
      <path d="M 21 26 C 17 15 22 9 31 9 C 37 9 40 11 41 15 A 36 30 0 0 1 59 15 C 60 11 63 9 69 9 C 78 9 83 15 79 26 A 36 30 0 1 1 21 26 Z" fill="#ffffff" />
      ...
      <ellipse cx="37" cy="52" rx="2.8" ry="3.8" fill="#3a3142" stroke="none" />
      <ellipse cx="63" cy="52" rx="2.8" ry="3.8" fill="#3a3142" stroke="none" />
