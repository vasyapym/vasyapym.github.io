...
function BustPortrait() {
  return (
    ...
    >
      ...
      <path d="M 32 100 C 32 86 37 76 44 73 L 56 73 C 63 76 68 86 68 100 Z" fill="#e94f64" />
      <rect x="45" y="80" width="10" height="7.5" rx="2" fill="#d13a50" stroke="none" />
      <path d="M 22.5 32.5 C 19 19 24 12.5 29.5 12.5 C 36 12.5 41.5 16 44.5 19.4 A 32 27 0 0 1 55.5 19.4 C 58.5 16 64 12.5 70.5 12.5 C 76 12.5 81 19 77.5 32.5 A 32 27 0 1 1 22.5 32.5 Z" fill="#ffffff" />
      ...
      <ellipse cx="40" cy="44" rx="2.8" ry="3.8" fill="#3a3142" stroke="none" />
      <ellipse cx="60" cy="44" rx="2.8" ry="3.8" fill="#3a3142" stroke="none" />
...
const PORTRAITS: readonly PortraitEntry[] = [
  {
    ...
    look: "The standing figure cropped to head + jumper shoulders like the knight portrait — button eyes, yellow nose, no mouth, ear bow, red jumper shoulders at the frame bottom. Now live in the game.",
    Mark: BustPortrait,
  },
  {
