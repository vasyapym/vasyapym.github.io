...
function BustPortrait() {
  return (
    ...
    >
      ...
      <path d="M 27 100 C 27 82 33 70 42 67 L 58 67 C 67 70 73 82 73 100 Z" fill="#e94f64" />
      <rect x="44" y="76" width="12" height="9" rx="2" fill="#d13a50" stroke="none" />
      <path d="M 22.5 26.5 C 19 13 24 6.5 29.5 6.5 C 36 6.5 41.5 10 44.5 13.4 A 32 27 0 0 1 55.5 13.4 C 58.5 10 64 6.5 70.5 6.5 C 76 6.5 81 13 77.5 26.5 A 32 27 0 1 1 22.5 26.5 Z" fill="#ffffff" />
      ...
      <ellipse cx="40" cy="38" rx="2.8" ry="3.8" fill="#3a3142" stroke="none" />
      <ellipse cx="60" cy="38" rx="2.8" ry="3.8" fill="#3a3142" stroke="none" />
