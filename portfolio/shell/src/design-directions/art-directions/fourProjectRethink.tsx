...
const FOREST_FOUR_ROUND: readonly { id: string; topline: string; Mark?: () => ReactElement }[] = [
  { id: "current", topline: "current · fox on the trail (adopted)", Mark: INCUMBENT_MARKS.fox },
...
const BLAST_FOUR_ROUND: readonly { id: string; topline: string; Mark?: () => ReactElement }[] = [
  { id: "current", topline: "current · three-frame filmstrip (adopted)", Mark: INCUMBENT_MARKS.blast },
...
const PLANCK_FOUR_ROUND: readonly { id: string; topline: string; Mark?: () => ReactElement }[] = [
  { id: "current", topline: "current · galaxies ignite (adopted)", Mark: INCUMBENT_MARKS.spiral },
