...
import { DraftCard, RoundSection, type RoundEntry } from "./roundSection";
import { FourProjectRethinkSection } from "./fourProjectRethink";
  ...
  return (
    <main className="signal-index art-directions">
      <div className="signal-index-shell">
        ...
        <FourProjectRethinkSection projects={projects} />
