...
export const TIERS: readonly Tier[] = [
  { id: "astra-6-max", name: "astra-6-max", band: "max", areas: ["ddos", "lanthimos", "zeitgeist", "japan"] },
  ...
  { id: "fable-5.1-low", name: "fable-5.1-low", band: "low", areas: ["go", "spirit-of-time", "darwin", "microservices"] },
  {
