...
export function KnightPortrait() {
  return (
    ...
    >
      ...
      {/* ear tips (bone) peeking above the dome — restored verbatim
          (F049 removed them; F051 reverts the CARD: the tips belong on
          the select poster. The in-game knight stays earless) */}
