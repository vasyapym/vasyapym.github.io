# minimize-iteration2 — S1–S5 full experiment history (restored)

Provenance: the pre-prune results log, recovered from git history
(blob 0fba9a0007ef399aa4d88fcc79d3c63f7d4be659, committed at 7b3f857,
2026-09-23). The owner-steered prune to practice+rounds happened in
d907388 (2026-09-25) on the theory that scaffolding was irrelevant; the
owner reversed that steer the same day — the brief shapes below are the
proven working format, restored to disk so they survive compaction.
Verbatim content below the line; do not edit the historical text.
