...
4. main page realm — v1 (n149) REJECTED by owner as flat/no-wow; rebuilt as "The Deep" (portfolio graph n148, brief 13): GPU-fluid abyss with lantern, seven behavioural creatures, abyssal audio, legend chart, dive→SPA handoff, ink flood/drain at the chip; 21/21 probe gates green, GL verified under SwiftShader. Owner look pending — flood beat and wake feel need real-GPU eyes (`npm run dev`).
