# HANDOFF — Ashen Dusk theme refinement (superseded stub)
...
Raw pre-compaction text: `docs/archive/handoffs/HANDOFF-ashen-dusk-refinement.md`.
Full decision trail: kitty-run graph `portfolio/projects/kitty-run/.project-history/graph.jsonl`.
